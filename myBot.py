...
async def on_message(message):
	...
	try:
		...
		Tears = ('아톰', '몰레큘', '셀', '슈퍼 셀', '하이퍼 셀', '워터', '클린 워터', '아이스', '클린 아이스', '하드 아이스', '소일', '샌드', '우드', '페이퍼', '글래스', '클리어 글래스', '미러', '클리어 미러', '스톤', '하드 스톤', '아이언', '하드 아이언', '브론즈', '클리어 브론즈', '브론즈 메달', '실버', '클리어 실버', '실버 메달', '골드', '클리어 골드', '골드 메달', '아메티스트(자수정)', '크리스탈', '클리어 크리스탈', '블랙 크리스탈', '다이아몬드', '블랙 다이아몬드', '아다만티움', '사파이어', '에메랄드', '루비', '우루', '비브라늄', '클래식', '프리미엄', '딜럭스', '익스트림', '플래티넘', '미스틱', '챌린저(티어)', '마스터(티어)', '그랜드', '챔피언(티어)', '레전드')
			...
			if 시작("ㄱ"):
				if 시간()[5:7] == "02" and 시간()[8:10] == "14" or\
				   ...
				   시간()[5:7] == "12" and 시간()[8:10] == "25":
					...
					await message.channel.send("현재 사용할수 없는 커맨드입니다.")
			if 시작("ㅅ"):
