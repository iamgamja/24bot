	...
	try:
		...
		if 시작(","):
			...
			if 시작("도움"):
				...
				embed.add_field(name=",도움", value="이 메시지를 출력합니다.", inline=False)
				...
				embed.add_field(name=",프사", value="프사를 출력합니다.", inline=False)
				...
				embed.add_field(name=",임베드", value="임베드를 만듭니다.", inline=False)
				...
				embed.add_field(name=",한영 <한글>", value="<한글>을 영타로 번역합니다.", inline=False)
